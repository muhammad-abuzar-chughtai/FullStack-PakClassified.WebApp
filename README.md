...
- **Role-Based Authorization** — Fine-grained access control (Admin, Customer)
- **CORS Configuration** — Properly configured for cross-origin requests

### 🏛️ Clean Architecture

- Strict **Separation of Concerns** across layers
- **Entity Layer & EFcore** — Abstracted data access for testability
...
- **Fluent APIs** — Efficient & Controlled Entity mapping to data table design
- **EF Core Migrations** — Version-controlled database Table changes
...
│   ├── Entity & EFcore/          # Domain entities, DbContext & migrations
...
│   │   │   ├── core/                 # programatic logic for frontend
│   │   │   │     ├── guards/         # Route protection
│   │   │   │     ├── interceptors/   # HTTP interceptors
│   │   │   │     ├── Models/         # TypeScript interfaces
│   │   │   │     └── Services/       # Api Calls (interface & compnents)
│   │   │   │
...
| **Entity & EFcore**      | Data Table Migration using Fluent APIs & SQL Server using LinQ    |
...
_Full Stack .NET & Angular Developer_
